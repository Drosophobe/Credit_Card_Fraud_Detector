...
DROP TABLE IF EXISTS ccf_mysql.user;
CREATE TABLE ccf_mysql.user (
                  id int NOT NULL AUTO_INCREMENT PRIMARY KEY ,
                  username varchar(50) NOT NULL,
                  password_hash varchar(128) NOT NULL,
                  UNIQUE(username)
                );
INSERT INTO ccf_mysql.user (id, username, password_hash) VALUES ('1', 'admin', '$2b$12$.JtAneBODWfF29sdJbCgceK8UKjISRSki3vHRIP7OMyk.xsTO49NG');
